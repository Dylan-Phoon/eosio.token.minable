(module
 ...
 (data (i32.const 352) "invalid supply\00")
 (data (i32.const 368) "max-supply must be positive\00")
 (data (i32.const 400) "token with symbol already exists\00")
 ...
 (func $_ZN5eosio5token4mineENSt3__112basic_stringIcNS1_11char_traitsIcEENS1_9allocatorIcEEEENS_5assetEy (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i64)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
  (local $7 i32)
